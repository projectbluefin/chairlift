...
not required. A failed status read keeps the previous comparison and badge
state, and reports that the staged outcome cannot be verified rather than
claiming the system is current.
